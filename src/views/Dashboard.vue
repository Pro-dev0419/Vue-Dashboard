...
export default {
    ...
    mounted() {
        ...
        recaptchaScript2.setAttribute('src', '/src/assets/js/utils.js')
                ...
                <div class="row">
                    <div class="col-12 mb-2">
                        <ol class="breadcrumb mb-2">
                            <li class="breadcrumb-item"><a href="/">Avio</a></li>
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="page-action">
                                ...
                                <div class="btn-group">
                                    <button type="button" class="btn dropdown-toggle after-none rounded-pill"
                                        data-bs-toggle="dropdown">
                                        <svg viewBox="0 0 16 16" width="16px" fill="currentColor"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                ...
                                <!-- btn:: recent chat -->
                                <button class="btn d-none d-sm-inline-flex rounded-pill" data-bs-toggle="modal"
                                    data-bs-target="#recent_chat" type="button">
                            ...
                            <section>
                                ...
                                <div class="tab2 rounded-4">
                                    <div class="owl-carousel owl-theme" id="live_coins">
                                        <div class="item card">
                                            <div class="card-body">
                                                <svg class="mb-4" xmlns="http://www.w3.org/2000/svg" width="30"
                                                    height="30" viewBox="0 0 64 65">
                                                ...
                                                <p class="small text-uppercase mb-1 text-muted">Bitcoin <span
                                                        class="small text-success">+1.25 <i
                                                            class="fa fa-level-up"></i></span></p>
                                        ...
                                        <div class="item card">
                                            <div class="card-body">
                                                <svg class="mb-4" xmlns="http://www.w3.org/2000/svg" width="30"
                                                    height="30" viewBox="0 0 64 65">
                                                    <path xmlns="http://www.w3.org/2000/svg" fill="#3A74BE"
                                                        fill-rule="nonzero"
                                                ...
                                                <p class="small text-uppercase mb-1 text-muted">Dash <span
                                                        class="small text-success">+0.17 <i
                                                            class="fa fa-level-up"></i></span></p>
                                        ...
                                        <div class="item card">
                                            <div class="card-body">
                                                ...
                                                <p class="small text-uppercase mb-1 text-muted">Devcoin <span
                                                        class="small text-success">+0.47 <i
                                                            class="fa fa-level-up"></i></span></p>
                                        ...
                                        <div class="item card">
                                            <div class="card-body">
                                                <svg class="mb-4" xmlns="http://www.w3.org/2000/svg" width="30"
                                                    height="30" viewBox="0 0 64 65">
                                                    <path fill="silver"
                                                        d="M32.2 64.1C14.6 64 .5 49.9.6 32.4.6 14.8 14.9.7 32.4.8 50 .9 64.1 15.1 64 32.6c-.2 17.5-14.4 31.6-31.8 31.5zm28.7-31.6c0-15.9-12.8-28.7-28.7-28.7-15.8 0-28.6 12.8-28.6 28.6 0 15.9 12.8 28.7 28.7 28.7 15.8 0 28.6-12.8 28.6-28.6z" />
                                                    <path fill="silver"
                                                        d="M56.6 32.5C56.4 46 45.5 56.9 32.1 56.8 18.5 56.6 7.7 45.6 7.9 32.2 8.1 18.7 19 8 32.3 8.1c13.5.1 24.3 11 24.3 24.4zm-25.9 8.7v-.3c.7-2.7 1.3-5.3 2-8 .1-.2.3-.5.6-.6.7-.3 1.4-.6 2.1-.8 1.6-.4 2.5-1.3 2.7-2.9.1-.7.4-1.4.6-2.2-1.7.7-3.2 1.3-4.8 1.9C35 24 36 20 37.1 15.8H28c-.6 0-.8.2-1 .8l-4.2 15.6c-.1.3-.4.6-.6.7-.9.4-1.9.7-2.8 1.1-.2.1-.5.2-.5.3-.4 1.3-.8 2.7-1.3 4.2 1.4-.6 2.6-1.1 4-1.6-.9 3.5-1.8 6.9-2.7 10.3h25.8c.5 0 .7-.1.8-.6.2-1 .5-2 .8-2.9.2-.7.3-1.4.5-2.2l-16.1-.3z" />
                                                    <path fill="#FFF"
                                                        d="M30.7 41.2c5.4.1 10.7.2 16.1.4-.2.8-.4 1.5-.5 2.2-.3 1-.6 1.9-.8 2.9-.1.5-.3.6-.8.6H18.9c.9-3.5 1.8-6.8 2.7-10.3-1.4.5-2.6 1-4 1.6.4-1.5.8-2.8 1.3-4.2 0-.2.3-.3.5-.3.9-.4 1.9-.7 2.8-1.1.3-.1.6-.4.6-.7L27 16.7c.1-.6.3-.8 1-.8h9.1C36 20 35 24.1 33.9 28.4c1.6-.7 3.1-1.3 4.8-1.9-.2.8-.5 1.5-.6 2.2-.2 1.6-1.1 2.5-2.7 2.9-.7.2-1.4.5-2.1.8-.2.1-.5.4-.6.6-.7 2.7-1.4 5.3-2 8v.2z" />
                                                </svg>
                                                <p class="small text-uppercase mb-1 text-muted">Litecoin <span
                                                        class="small text-danger">+0.66 <i
                                        ...
                                        <div class="item card">
                                            <div class="card-body">
                                                <svg class="mb-4" xmlns="http://www.w3.org/2000/svg" width="30"
                                                    height="30" viewBox="0 0 64 65">
                                                    <path fill="#4C4C4C"
                                                        d="M58.1 49.2H45.6V32L31.7 45.9 17.8 32v17.2H4.9c5.6 8.9 15.5 14.9 26.8 14.9s21.2-5.9 26.8-14.9h-.4z" />
                                                    <path fill="#FF6B01"
                                                        d="M11.2 42.6V16.2l20.5 20.5 20.5-20.5v26.4h9.5c1.1-3.2 1.7-6.6 1.7-10.2C63.4 14.9 49.2.7 31.7.7S0 14.9 0 32.4c0 3.6.6 7 1.7 10.2h9.5z" />
                                                </svg>
                                                <p class="small text-uppercase mb-1 text-muted">Monero <span
                                                        class="small text-success">+0.33 <i
                                                            class="fa fa-level-up"></i></span></p>
                                            ...
                                            <div class="card-body">
                                                <svg class="mb-4" xmlns="http://www.w3.org/2000/svg" width="30"
                                                    ...
                                                    <g xmlns="http://www.w3.org/2000/svg" fill="none"
                                                        ...
                                                        <path fill="#FFF"
                                                            d="M39.8 48c13.1-11.3 5.4-31.9-21.5-32.5.3 18.2-2.2 32.2 16.1 32.2 5.7-8.7 1.5-17.3-7.8-25.8 9.2 3.6 17 14.6 13.2 26.1z" />
                                                    </g>
                                                </svg>
                                                <p class="small text-uppercase mb-1 text-muted">Peercoin <span
                                                        class="small text-danger">+0.11 <i
                                                            class="fa fa-level-down"></i></span></p>
                                            ...
                                            <div class="carousel-item active">
                                                <div class="row g-2">
                                                    ...
                                                    <div class="col-lg-3 col-md-6 col-sm-6 col-6">
                                                        <div class="card">
                                                            <div class="card-body">
                                                                <p class="small text-uppercase mb-2 text-muted">On Hold
                                                                </p>
                                                                <h5 class="mb-0">18</h5>
                                                            </div>
                                                        </div>
                        ...
                        <div class="tab-content mt-3">
                            ...
                            <div class="tab-pane fade" id="step3">
                                ...
                                <div class="text-end">
                                    <button type="button" class="btn btn-secondary"
                                        data-bs-dismiss="modal">Close</button>
                                    <button class="btn bg-secondary text-light next text-uppercase">Upload
                                        Files</button>
                                </div>
                            </div>
                            <!-- start: Upload Files -->
                                                ...
                                                <div class="max-width-70 text-end">
                                                    ...
                                                    <div class="card border-0 p-3 bg-primary text-light">
                                                        <div class="message">Yes, Orlando Allredy done <br> There are
                                                            many variations of passages of Lorem Ipsum available</div>
                                                    </div>
                                                </div>
                                                <!-- More option -->
                                                <div class="btn-group">
