                            ...
                            <div style="max-width: 25rem;">
                                <div class="mb-4">
                                    <svg width="48" height="36" viewBox="0 0 48 36" fill="none"
                                        ...
                                        <rect class="fill-primary" x="13.5" y="1.5" width="33" height="33" rx="16.5"
                                ...
                                <ul class="list-unstyled mb-5">
                                    ...
                                    <li>
                                        <span class="d-block mb-1 fs-4 fw-light">Easily add &amp; manage your
                                            services</span>
                                        <span class="color-600">It brings together your tasks, projects, timelines,
                                            files and more</span>
                                    </li>
                                </ul>
                                <div class="mb-2">
                            ...
                            <div class="card shadow p-4 p-md-5" style="max-width: 32rem;">
                                ...
                                <form class="row g-3">
                                    <div class="col-12 text-center mb-4">
                                        <img src="@/assets/img/auth-404.svg" class="w240 mb-4" alt="" />
                                        <h1 class="display-1">404</h1>
                                        <h5>OOP! PAGE NOT FOUND</h5>
                                        <span class="text-muted">Sorry, the page you're looking for doesn;t exist. if
                                            you think something is brlken, report a problem.</span>
                                    </div>
                                    <div class="col-12 text-center">
                                        <a href="/" title=""
                                            class="btn btn-lg btn-block btn-dark lift text-uppercase">Back to Home</a>
                                    </div>
                                </form>
                                <!-- End Form -->
                            </div>
            ...
            <div class="modal-dialog modal-dialog-vertical right-side modal-dialog-scrollable">
                <div class="modal-content">
                    ...
                    <div class="px-xl-4 modal-body custom_scroll">
                        ...
                        <div class="mb-4">
                            <a class="btn lift mb-1 btn-outline-secondary" href="./marketing/index.html">Marketing
                                page</a>
                            <a class="btn lift mb-1 btn-outline-secondary" href="./onepgae-uikit/onepage.html">Landing
                                page</a>
                            <a class="btn lift mb-1 btn-outline-secondary" href="./onepgae-uikit/index.html">One page Ui
                                Kit Elements</a>
                        </div>
                    </div>
